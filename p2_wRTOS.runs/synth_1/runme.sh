...
HD_PWD='C:/Users/surya/ece544/p2_wRTOS/p2_wRTOS.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log embsys_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source embsys_wrapper.tcl
