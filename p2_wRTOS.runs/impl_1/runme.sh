...
HD_PWD='C:/Users/surya/ece544/p2_wRTOS/p2_wRTOS.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log embsys_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source embsys_wrapper.tcl -notrace
