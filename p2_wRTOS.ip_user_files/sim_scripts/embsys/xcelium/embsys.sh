...
execute()
{
  xrun $xrun_opts \
       ...
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../p2_wRTOS.srcs/sources_1/bd/embsys/ipshared/85a3" \
       +incdir+"$ref_dir/../../../../p2_wRTOS.srcs/sources_1/bd/embsys/ipshared/ec67/hdl" \
       +incdir+"../../../../p2_wRTOS.srcs/sources_1/bd/embsys/ipshared/85a3" \
       +incdir+"../../../../p2_wRTOS.srcs/sources_1/bd/embsys/ipshared/ec67/hdl"
}
