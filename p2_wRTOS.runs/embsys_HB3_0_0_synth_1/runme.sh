...
HD_PWD='C:/Users/surya/ece544/p2_wRTOS/p2_wRTOS.runs/embsys_HB3_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log embsys_HB3_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source embsys_HB3_0_0.tcl
